    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'uygulama', translation: 'practice' },
            { original: 'merhaba', translation: 'hello' },
            { original: 'ev', translation: 'house' },
            {
              original: 'yazılım mühendisi',
              translation: 'software developer'
            },
            { original: 'çevirmek', translation: 'translate' },
            { original: 'inanılmaz', translation: 'amazing' },
            { original: 'köpek', translation: 'dog' },
            { original: 'kedi', translation: 'cat' }
          ]
        };
        return supertest(app)
          .post('/api/user')
